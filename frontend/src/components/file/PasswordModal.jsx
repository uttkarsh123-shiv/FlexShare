        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ position: 'relative', marginBottom: '1.75rem' }}>
            <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} placeholder="Enter password" autoFocus minLength={4}
              ...
              onFocus={e => { e.target.style.borderColor = '#000000'; e.target.style.boxShadow = '3px 3px 0px #000000'; }}
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            <button type="submit" disabled={disabled}
              style={{ flex: 1, padding: '11px', border: 'none', background: disabled ? '#cccccc' : '#000000', color: disabled ? '#888888' : 'white', fontSize: '0.875rem', fontWeight: 700, cursor: disabled ? 'not-allowed' : 'pointer', fontFamily: "'Inter', sans-serif", textTransform: 'uppercase', letterSpacing: '0.04em' }}>
